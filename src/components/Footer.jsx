...
export default function Footer() {
  return (
    <footer className="md:mb-0 mb-24">
      <div className="mx-auto w-full max-w-screen-xl px-[32px] py-6">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0 max-w-[300px]">
            ...
            <a>A Website for Website Programming Big Project"</a>
          </div>
          <div className="grid grid-cols-2 gap-1 sm:gap-1 sm:grid-cols-3">
            <div>
              <h2 className="mb-6 text-sm font-semibolduppercase">Navigasi</h2>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center">
            © 2023 <a className="hover:underline">web 5 A</a>. All Rights
            Reserved.
          </span>
          <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
            ...
            <a
              href="https://github.com/doubleonellc"
